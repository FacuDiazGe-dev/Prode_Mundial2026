...
/* ============================================================
   PARTIDO CARD — ESTRUCTURA 3 BLOQUES
   CARD1 | RESULTADO | CARD2
   ============================================================ */
...
""",
                    ...
                    with c_right:
                        st.markdown(
                            f"""
<div class="pred-team-card right">
{flag_html(bandera2)}
